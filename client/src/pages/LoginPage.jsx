        ...
        <form onSubmit={handleSubmit} style={{ width: "100%" }}>
          ...
          <div style={{ width: "100%", marginTop: 18 }}>
            ...
            <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
              ...
              />
              <div onClick={() => setShowPassword((s) => !s)} style={styles.eyeIcon}>
                <svg
                  viewBox="0 0 24 24"
                  width="18"
                  height="18"
...
const styles = {
  ...
  blobTop: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle at 30% 30%, oklch(0.55 0.1 250 / 0.35), transparent 70%)",
  ...
  blobBottom: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle at 60% 60%, oklch(0.4 0.09 280 / 0.35), transparent 70%)",
  ...
  card: {
    ...
    borderRadius: 16,
    boxShadow:
      "0 30px 60px -15px oklch(0.1 0.02 260 / 0.5), 0 0 0 1px oklch(1 0 0 / 0.08)",
  ...
  button: {
    ...
    fontWeight: 700,
    cursor: "pointer",
    boxShadow: "0 8px 18px -6px oklch(0.4 0.1 260 / 0.55)",
    letterSpacing: "0.01em",
